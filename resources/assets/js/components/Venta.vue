                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row border">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Artí­culo <span style="color:red;" v-show="idarticulo==0">(*Seleccione)</span></label>
                                    <div class="form-inline">
                                        <input type="text" class="form-control" v-model="codigo" @keyup.enter="buscarArticulo()" placeholder="Ingrese artí­culo">
    ...
    export default {
        ...
        methods : {
            ...
            cambiarPagina(page,buscar,criterio){
                ...
                //Envia la peticin para visualizar la data de esa pagina
                ...
                if(me.idarticulo==0 || me.cantidad==0 || me.precio==0){
                    ...
                    if(me.encuentra(me.idarticulo)){
                        swal({
                            type: 'error',
                            title: 'Error...',
                            text: 'Ese artí­culo ya se encuentra agregado!',
                            })
                    }
                    else{
