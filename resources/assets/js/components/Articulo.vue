                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Categori­a</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="nombre" class="form-control" placeholder="Nombre de artí­culo">                                        
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods : {
            ...
            validarArticulo(){
                ...
                if (!this.nombre) this.errorMostrarMsjArticulo.push("El stock no puede estar vacio.");
                ...
                switch(modelo){
                    case "articulo":
                    {
                        switch(accion){
                            ...
                            {
                                this.modal = 1;
                                this.tituloModal = 'Registrar Arti­culo';
                                this.idcategoria =0;
                                this.nombre_categoria= '';
                                this.codigo= '';
                                this.nombre= '';
