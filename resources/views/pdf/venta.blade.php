...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/descarga.jpg" alt="incanatoIT" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>MoralesR</b><br>Roberth Morales 1927, Bucara , Colombia<br>Telefono:(+57)3227188551<br>Email:robinmoralesquiroz@gmail.com
                </p>
            </div>
            <div id="fact">
